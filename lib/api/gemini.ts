...
**worldview는 300자 미만이면 안 됩니다.** 최소 300자, 가능하면 더 상세히 서술하세요.
{
  "name": "캐릭터 이름",
  "gender": "성별",
  "species": "종족",
  ...
  "height": "키 (예: 148cm)",
  "job": "직업",
  "worldview": "세계관 (최소 300자, 필수): 시대·장소·물리/마법 법칙·금기·등장 인물 간 관계·말투 통일 규칙·작품 밖 단어 노출 시 대응 방식 등을 매우 자세히 서술. AI가 이 세계에 완전히 몰입할 수 있을 정도로 구체적으로.",
